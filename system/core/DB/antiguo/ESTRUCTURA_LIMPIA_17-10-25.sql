...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-05-2024 a las 18:00:00
...
-- Deshabilitar temporalmente las restricciones de clave foránea para una importación segura
...
CREATE TABLE `table_es_cierre` (
  ...
  `id_user` int(11) DEFAULT NULL,
  `fecha_cierre` varchar(10) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `table_es_venta` (
  ...
  `fecha_venta` varchar(50) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
...
CREATE TABLE `table_usuarios` (
  ...
  `usuario_nombres` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `usuario_apellidos` varchar(100) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `usuario_email` varchar(150) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci NOT NULL,
  `usuario_telefono` varchar(20) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `usuario_ci` varchar(15) CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
  `usuario_rol_id` int(11) NOT NULL,
  `usuario_departamento_id` int(11) NOT NULL,
  `usuario_direccion` text CHARACTER SET utf8mb3 COLLATE utf8mb3_spanish_ci DEFAULT NULL,
...
--
-- Indices de la tabla `table_bienes_seccion`
--
ALTER TABLE `table_bienes_seccion`
...
--
ALTER TABLE `table_bienes_inventario`
  ADD CONSTRAINT `fk_bien_departamento` FOREIGN KEY (`bien_depatamento_id`) REFERENCES `table_bienes_departamentos` (`depatamento_bien_id`),
  ADD CONSTRAINT `fk_bien_grupo` FOREIGN KEY (`grupo_id`) REFERENCES `table_bienes_grupo` (`id_grupo`),
  ADD CONSTRAINT `fk_bien_seccion` FOREIGN KEY (`seccion_id`) REFERENCES `table_bienes_seccion` (`seccion_id`),
  ADD CONSTRAINT `fk_bien_subgrupo` FOREIGN KEY (`subgrupo_id`) REFERENCES `table_bienes_subgrupo` (`subgrupo_id`);
...
--
-- Filtros para la tabla `table_es_cierre`
--
ALTER TABLE `table_es_cierre`
  ADD CONSTRAINT `table_es_cierre_ibfk_1` FOREIGN KEY (`id_estacion`) REFERENCES `table_es_estacion` (`id_estacion`);
...
--
-- Habilitar las restricciones de clave foránea y confirmar la transacción
--
