...
--
-- Volcado de datos para la tabla `table_per_cambio_status_personal`
--

INSERT INTO `table_per_cambio_status_personal` (`id_cambioPersonal`, `id_personal`, `idStatus`, `textCambio`, `user_id`) VALUES
(1, 144, 0, 'ya no labora en el servicio', 2),
(2, 12, 0, 'CULMINACION DE CONTRATO', 12);
