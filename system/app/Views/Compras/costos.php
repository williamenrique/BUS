                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <div class="callout callout-success">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <p class="mb-0"><strong>Unidad:</strong> <span id="detalleInfoUnidad"></span></p>
                                                <p class="mb-0"><strong>Fecha Despacho:</strong> <span id="detalleInfoFecha"></span></p>
                                            </div>
                                            <div class="col-md-6">
                                                <p class="mb-0"><strong>Tasa Aplicada:</strong> <span id="detalleInfoTasa" class="font-weight-bold text-primary"></span></p>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <table class="table table-sm table-bordered">
                                            ...
                                            <tfoot class="bg-light font-weight-bold">
                                                <tr>
                                                    ...
                                                    <td class="text-right" id="totalDetalleDivisa"></td>
                                                    <td class="text-right" id="totalDetalleBs"></td>
                                                </tr>
                                            </tfoot>
                                        </table>
                                    </div>
